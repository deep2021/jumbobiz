					...
					<div class="box-content">
						...
						<thead>
						  <c:forEach var="list" items="${data}" >
							<tr>
							<td class="center">${list.fname}</td>	
							<td class="center">${list.email}</td>
								<td class="center">${list.mobile}</td>
								<td class="center">${list.role}</td>
									<td class="center">${list.date}</td>
								<%-- <td class="center">${list.city}</td>
								<td class="center">${list.state}</td>
								<td class="center">${list.country}</td>
							 --%>
									<!-- <span class="label label-success">Active</span> -->
								
								 <td class="center">
									
									<a class="btn btn-danger" href="deleteuser/${list.id}"">
								 ...
								 <td class="center">
									...
									<a class="btn btn-info" href="makeSuppler/${list.id}">
