					...
					<div class="col-sm-12">
					 ...
					 --%>	<div class="form-group">
						<form:label path="category">Product Category</form:label>
								 <form:radiobutton path="category" value="Android"/>Android
								 <form:radiobutton path="category" value="Windows"/>Windows
								 <form:radiobutton path="category" value="Linux"/>Linux
								 <form:radiobutton path="category" value="Mac"/>Mac
						</div>
						<%-- <div class="row">
